...
var all_questions = [{
  ...
  question_string: "How many header tags in html?",
  choices: {
    correct: "Six",
    wrong: ["Five", "Two", "Four"]
  }
}, {
  question_string: 'Full form of JS',
  choices: {
    correct: "JavaScript",
    wrong: ["JavaSwing", "JavaStructure", "JavaSlice"]
  }
},
{
  question_string: 'Full form of HTML',
  choices: {
    correct: "Hyper Text Markup Language",
    wrong: ["Hypo Test Makein Language", "Hyper Text Markdown Language", "Hyper Text Making Language"]
  }
}];
